...
@section('content')
    <div class="mb-4">
        <h1 class="mb-1">{{ __('app.expense_report') }}</h1>
        <p class="text-muted mb-0">{{ __('app.expense_report_description') }}</p>
    </div>

    <div class="card table-card p-4 mb-4">
        <form method="GET" action="{{ route('financial-statements.expense-report') }}">
            <div class="row g-3">
                <div class="col-md-5">
