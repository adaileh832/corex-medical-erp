...
<head>
    ...
    <title>Edit Patient | تعديل مريض</title>
    <style>
...
<div class="container">
    <div class="topbar">
        <div>
            <h1 style="margin:0;">تعديل مريض / Edit Patient</h1>
            <p style="margin:8px 0 0;color:#64748b;">تحديث بيانات المريض داخل CoreX</p>
        </div>
        ...
        <form method="POST" action="{{ route('patients.update', $patient) }}">
            ...
            <div class="grid">
                <div>
                    ...
                    <input id="full_name" type="text" name="full_name" value="{{ old('full_name', $patient->display_name) }}" required>
                </div>
                ...
                <div>
                    ...
                    <select id="gender" name="gender">
                        ...
                        <option value="male" @selected(old('gender', $patient->gender) === 'male')>Male / ذكر</option>
                        <option value="female" @selected(old('gender', $patient->gender) === 'female')>Female / أنثى</option>
                    </select>
                </div>

                <div>
                    <label for="date_of_birth">تاريخ الميلاد / Date of Birth</label>
                    <input id="date_of_birth" type="date" name="date_of_birth" value="{{ old('date_of_birth', optional($patient->date_of_birth)->format('Y-m-d')) }}">
                </div>
